...
enum EAnalysisContainerFlags {
   ...
   void                      SetListToFolder(Bool_t flag) {TObject::SetBit(kListToFolder,flag);}
   ...
   Bool_t                    IsListToFolder() const    {return TObject::TestBit(kListToFolder);}
